...
The compiled reference is called a semantic contract: one JSON file per verse, small enough to read over coffee, holding everything the machine will ever know about what the commentary commits to (paper §3.1). A contract has five parts.
